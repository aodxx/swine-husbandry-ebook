...
for topic in data['topics']:
    if topic['id']=='2.14':
        topic.update({'status':'EDITORIAL_REVIEW','research_started':'2026-08-23','research_completed':'2026-08-23','draft_completed':'2026-08-23','fact_checked':'2026-08-23','last_reviewed':'2026-08-23','reviewed_by':'Manus AI','source_count':4,'subtopic_quality_gate':'PASS','remaining_questions':['ไม่มี target ตัวเลขเดียวที่ใช้กับทุกตลาดและระบบไทยได้']})
data['current_focus']='2.14'
data['next_topic']='2.15'
data['chapter_2_production']['current_topic']='2.14'
