...
for t in d['topics']:
 if t['id']=='3.9': t.update({'status':'EDITORIAL_REVIEW','research_started':'2026-08-23','research_completed':'2026-08-23','draft_completed':'2026-08-23','fact_checked':'2026-08-23','last_reviewed':'2026-08-23','reviewed_by':'Manus AI','source_count':5,'subtopic_quality_gate':'PASS','remaining_questions':['ต้องขอใบเสนอราคาตามแบบและตรวจข้อกำหนดสถานที่จริงก่อนลงทุน']})
