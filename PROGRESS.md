...
Chapter 1 status: `OWNER_REVIEW_PASSED`. Current Focus is `3.10` — เงินทุนหมุนเวียน. Next Topic is `3.10` — เงินทุนหมุนเวียน; `CHAPTER_3_CONTENT_PRODUCTION`.
...
|---|---:|
| Drafted or beyond | 35 |
| Fact checked or beyond | 35 |
| Editorial review or beyond | 35 |
| Approved | 0 |
| Published | 0 |

## Current Focus

- **Current Topic:** `3.10` — เงินทุนหมุนเวียน
- **Next Topic:** `3.10` — เงินทุนหมุนเวียน
